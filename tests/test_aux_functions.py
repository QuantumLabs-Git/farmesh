...
from farmesh import AutoDistributedConfig
from farmesh.server.throughput import measure_compute_rps
from farmesh.utils.convert_block import QuantType
from farmesh.utils.misc import DUMMY, is_dummy
from farmesh.utils.packaging import pack_args_kwargs, unpack_args_kwargs
...
def test_bnb_not_imported_when_unnecessary():
    ...
    If this test fails, please change your code to import bitsandbytes and/or farmesh.utils.peft
    ...
    subprocess.check_call([sys.executable, "-c", "import farmesh, sys; assert 'bitsandbytes' not in sys.modules"])
