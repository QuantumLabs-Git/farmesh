...
This script may be used for launching lightweight CPU machines serving as bootstrap nodes to a FarMesh swarm.
...
from farmesh.server.reachability import ReachabilityProtocol
