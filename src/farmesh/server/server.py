...
import farmesh
from farmesh.constants import DTYPE_MAP, PUBLIC_INITIAL_PEERS
from farmesh.data_structures import CHAIN_DELIMITER, UID_DELIMITER, ModelInfo, ServerInfo, ServerState, parse_uid
from farmesh.server import block_selection
from farmesh.server.backend import TransformerBackend, merge_inference_pools_inplace
from farmesh.server.block_utils import get_block_size, resolve_block_dtype
from farmesh.server.from_pretrained import load_pretrained_block
from farmesh.server.handler import TransformerConnectionHandler
from farmesh.server.memory_cache import MemoryCache
from farmesh.server.reachability import ReachabilityProtocol, check_direct_reachability, validate_reachability
from farmesh.server.throughput import get_dtype_name, get_server_throughput
from farmesh.utils.auto_config import AutoDistributedConfig
from farmesh.utils.convert_block import QuantType, check_device_balance, convert_block
from farmesh.utils.dht import declare_active_modules, get_remote_module_infos
from farmesh.utils.misc import get_size_in_bytes
from farmesh.utils.ping import PingAggregator
from farmesh.utils.random import sample_up_to
from farmesh.utils.version import get_compatible_model_repo
...
class Server:
    ...
    def _choose_num_blocks(self) -> int:
        ...
        if self.adapters:
            # Delay import of farmesh.utils.peft to avoid unnecessary import of bitsandbytes
            from farmesh.utils.peft import estimate_adapter_memory_per_block
