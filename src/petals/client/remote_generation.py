...
from farmesh.client.inference_session import InferenceSession
from farmesh.client.remote_sequential import RemoteSequential
from farmesh.utils.misc import DUMMY, docstring_from
...
class RemoteGenerationMixin(_SkipTokensMixin):
        ...
        with context_manager as session:
            ...
            if n_prev_tokens > 0:
                if kwargs.get("num_beams", 1) > 1:
                    logger.warning(
                        "Beam search will not work properly in the resumed farmesh.InferenceSession "
    ...
    def _fix_generate_kwargs(kwargs: dict):
        ...
        # Support do_sample = {0, 1} for backward compatibility with FarMesh < 2.1.0
