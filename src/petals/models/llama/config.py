...
from farmesh.client.lm_head import LMHeadConfig
from farmesh.client.ptune import PTuneConfig
...
class DistributedLlamaConfig(LlamaConfig, ClientConfig, PTuneConfig, LMHeadConfig):
    ...
    def from_pretrained(
        ...
        config.use_cache = True  # use_cache=False leads to identical results but is slower and not supported by FarMesh
        return result
