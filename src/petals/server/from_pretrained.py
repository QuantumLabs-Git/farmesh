...
from farmesh.constants import DTYPE_MAP
from farmesh.models.mixtral import WrappedMixtralBlock
...
from farmesh.utils.disk_cache import DEFAULT_CACHE_DIR, allow_cache_reads, allow_cache_writes, free_disk_space_for
from farmesh.utils.hf_auth import always_needs_auth
...
def _find_index_file(
    ...
    # If we have cached weights (e.g., Pickle from older FarMesh versions), reuse them
